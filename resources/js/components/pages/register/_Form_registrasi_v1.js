...
export default class _Form_registrasi_v1 extends Component {
    constructor(props) {
        super(props);
...
if (document.getElementById('_form_registrasi_v1')) {
    ReactDOM.render(<_Form_registrasi_v1 />, document.getElementById('_form_registrasi_v1'));
}
