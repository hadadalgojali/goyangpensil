...
export default class _Image_category_list extends Component {
    constructor(props) {
        super(props);
        url     = reactInit.url;
        id = reactInit.id;
...
if (document.getElementById('_image_category_list')) {
    ReactDOM.render(<_Image_category_list />, document.getElementById('_image_category_list'));
}
