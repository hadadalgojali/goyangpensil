...
import p_Dashboard from './../pages/_dashboard';
import p_About from './../pages/_about';
    ...
    render() {
        return (
          ...
          <div>
                      ...
                      <ul className="site-menu js-clone-nav mr-auto d-none d-lg-block">
                        ...
                        <li className="has-children">
                          ...
                          <ul className="dropdown">
                            ...
                            <li><Link to="/pages/_about">Kontak</Link></li>
            ...
            <Route exact path="/pages/_about" component={p_About}/>
          </div>
          </Router>
        );
    }
