...
<html lang="en">
  <head>
    ...
    <!-- <link rel="stylesheet" href="{{asset('assets/template/public/css/jquery-ui.css')}}"> -->
    <link rel="stylesheet" href="{{asset('assets/template/public/css/bootstrap-datepicker.css')}}">
    <link rel="stylesheet" href="{{asset('assets/template/public/css/aos.css')}}">
    <link rel="stylesheet" href="{{asset('assets/template/public/css/rangeslider.css')}}">
